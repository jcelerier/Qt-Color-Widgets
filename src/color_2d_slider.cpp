    ...
    for (int y = 0; y < size.height(); ++y)
    {
      ...
      for (int x = 0; x < size.width(); ++x)
      {
        ...
        square.setPixel(
            ...
            y,
            QColor::fromHsvF(
                PixHue(xfloat, yfloat), PixSat(xfloat, yfloat), PixVal(xfloat, yfloat))
                .rgb());
      }
    }
  }
...
Color2DSlider::Color2DSlider(QWidget* parent) : QWidget(parent), p(new Private)
{
