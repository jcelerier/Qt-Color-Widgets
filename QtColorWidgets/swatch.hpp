...
protected:
  ...
  W_SLOT(paletteModified)

  /**
   * \brief Palette shown by the widget
   */
  // W_PROPERTY(const ColorPalette&, palette READ palette WRITE setPalette
  ...
  W_PROPERTY(
      ColorSizePolicy,
      colorSizePolicy READ colorSizePolicy WRITE setColorSizePolicy NOTIFY colorSizePolicyChanged)
  ...
  W_PROPERTY(
      int,
      forcedColumns READ forcedColumns WRITE setForcedColumns NOTIFY forcedColumnsChanged)
