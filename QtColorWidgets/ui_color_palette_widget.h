...
public:
    ...
    void retranslateUi(QWidget *color_widgets__ColorPaletteWidget)
    {
        ...
        button_palette_open->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Open a new palette from file", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_palette_new->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Create a new palette", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_palette_duplicate->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Duplicate the current palette", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_palette_delete->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Delete the current palette", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_palette_revert->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Revert changes to the current palette", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_palette_save->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Save changes to the current palette", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_color_add->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Add a color to the palette", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        button_color_remove->setToolTip(QApplication::translate("color_widgets::ColorPaletteWidget", "Remove the selected color from the palette", 0));
#endif // QT_NO_TOOLTIP
